const CACHE_VERSION = "roadpulse-v25-navfix-1";
const APP_CACHE = `${CACHE_VERSION}-app`;
const CDN_CACHE = `${CACHE_VERSION}-cdn`;

const APP_SHELL = [
  "/",
  "/assets/styles.css?v=webv25navfix1",
  "/assets/app.js?v=webv25navfix1",
  "/assets/pwa.js?v=webv25navfix1",
  "/manifest.webmanifest?v=webv25navfix1",
